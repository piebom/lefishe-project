...
function UserCard({imageURL, naam, bijnaam, bio}: Props) {
  return (
    <motion.div className="flex flex-col justify-center items-center hover:scale-105"
    initial={{
        y: -100,
        opacity: 0
    }}
    ...
    <div className="bg-white w-[400px] min-h-[365px] rounded-2xl flex flex-col items-center pt-20 p-10">
