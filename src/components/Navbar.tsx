...
function Navbar() {
  ...
  return (
    <div className="flex max-h-screen items-center">
      <motion.div
        className="invisible fixed z-20 m-5 h-[240px] w-[75px] rounded-[15px] bg-[#3d3d3d] shadow-3xl lg:visible"
        initial={{
          x: -150,
          opacity: 0,
          scale: 0.5,
      ...
      >
        <div className="flex flex-col justify-start p-[13px]">
          <div
            ...
            className="absolute mb-[9px] h-[47px] w-[47px] rounded-[15px] bg-[#fbfbfb]"
            style={{
          ...
          <button
            ...
            className="z-10 mb-[9px] flex h-[47px] w-[47px] items-center justify-center rounded-[15px]"
          >
          ...
          >
            <Image
              className="z-10"
              color={activeIndex == 1 ? "#3d3d3d" : "#fbfbfb"}
            />
          </button>
          <button
            key={2}
            ...
            className="mb-[9px] flex h-[47px] w-[47px] items-center justify-center rounded-[15px]"
          >
            <Award
              className="z-10"
              color={activeIndex == 2 ? "#3d3d3d" : "#fbfbfb"}
            />
          </button>
          <button
            key={3}
            ...
            className="flex h-[47px] w-[47px] items-center justify-center rounded-[15px]"
          >
            <User
              className="z-10"
              color={activeIndex == 3 ? "#3d3d3d" : "#fbfbfb"}
            />
          </button>
        </div>
      </motion.div>
